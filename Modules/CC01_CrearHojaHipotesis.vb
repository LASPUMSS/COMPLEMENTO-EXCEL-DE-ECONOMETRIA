...
Module CC01_CrearHojaHipotesis
    ...
    Public Sub hojaHipotesis()
        ...
        Dim celdaIncial As Excel.Range = hojaActiva.Cells(1, 1).End(Excel.XlDirection.xlDown)
        ...
        If Verificar1 = "PROMEDIO" And Verificar2 = "DETERMINACION DE BETAS" And Verificar3 = "DETERMINACIÓN DE VARIANZA Y DESVIACIÓN ESTANDAR." And Verificar4 = "PROPIEDADES:" Then
            ...
            n = Globals.ThisAddIn.Application.ActiveCell.End(Excel.XlDirection.xlDown).Row + 2
            ...
            Globals.ThisAddIn.Application.Selection.PasteSpecial(Paste:=Excel.XlPasteType.xlPasteValues,
                                                                 Operation:=Excel.Constants.xlNone,
