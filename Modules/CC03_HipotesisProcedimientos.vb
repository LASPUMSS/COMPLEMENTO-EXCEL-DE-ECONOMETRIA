...
Module CC03_HipotesisProcedimientos
    Public Sub llamadaHipotesis(ByVal txt_Hipotesis As String, ByVal txt_Hp As String, ByVal txt_NvSf As String, ByVal ComB_Betas As String)
        ...
        If filaInicial = "DETERMINACION DE BETAS" And filaFinal = "SEC" _
            ...
            Globals.ThisAddIn.Application.ActiveCell.End(Excel.XlDirection.xlUp).Select()
    ...
    Public Sub hipotesisSimples(ByVal txt_Hipotesis As String, ByVal txt_Hp As String, ByVal txt_NvSf As String, ByVal ComB_Betas As String)
        ...
        With Globals.ThisAddIn.Application
            ...
            .ActiveCell.Offset(4, 1).HorizontalAlignment = Excel.Constants.xlCenter
            ...
            .ActiveCell.Offset(5, 1).HorizontalAlignment = Excel.Constants.xlCenter
            ...
            .ActiveCell.Offset(21, 1).HorizontalAlignment = Excel.Constants.xlCenter

            'PASO 6
            .ActiveCell.Offset(24, 1).Value = "p valor="
            .ActiveCell.Offset(24, 1).Font.Bold = False
            .ActiveCell.Offset(24, 1).HorizontalAlignment = Excel.Constants.xlCenter

            .ActiveCell.Offset(24, 2).FormulaR1C1 = "=T.DIST.2T(ABS(R[-7]C),R10C2)"
            .ActiveCell.Offset(24, 2).Font.Bold = False
            .ActiveCell.Offset(24, 2).HorizontalAlignment = Excel.Constants.xlCenter
            ...
            .ActiveCell.Offset(25, 1).HorizontalAlignment = Excel.Constants.xlCenter
        ...
        With Globals.ThisAddIn.Application.Selection.Font
            ...
            .TintAndShade = 0
        End With
        Globals.ThisAddIn.Application.Selection.Font.Underline = Excel.XlUnderlineStyle.xlUnderlineStyleSingle
    End Sub
